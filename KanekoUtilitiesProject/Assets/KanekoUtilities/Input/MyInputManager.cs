...
namespace KKUtilities
{
    public class MyInputManager : BaseManager<MyInputManager>
    {
        ...
        public static bool GetButton(Button button, GamePad.Index index = GamePad.Index.One)
        {
            ...
            KeyConfigData.ButtonKeyConfig buttonConfig = keyConfig.buttonConfigList.Find(n => n.buttonName == button);
        ...
        public static Vector2 GetAxis(Axis axis, GamePad.Index index = GamePad.Index.One)
        {
            ...
            KeyConfigData.AxisKeyConfig axisKeyConfig = keyConfig.axisConfigList.Find(n => n.axisName == axis);
        ...
        public static float GetTrigger(Trigger trigger, GamePad.Index index = GamePad.Index.One)
        {
            ...
            KeyConfigData.TriggerKeyConfig triggerKeyConfig = keyConfig.triggerConfigList.Find(n => n.triggerName == trigger);
