...
public class CameraContoller : MonoBehaviour
{
    ...
    public bool CanMouseControl { get; private set; }
    ...
    void Start()
    {
        ...
        ChangeMouseControl(true);
    }

    void OnDestroy()
    {
        ChangeMouseControl(false);
    }
    ...
    void Update()
    {
        ...
        {
            ChangeMouseControl(!CanMouseControl);
        }
    }
    ...
    Vector2 GetInputVector()
    {
        ...
        if (!MyInputManager.IsConnectJoyPad && CanMouseControl)
        {
    ...
    void ChangeMouseControl(bool value)
    {
        CanMouseControl = value;
